...
class CourseLessonSubscriptionTests(APITestCase):
    ...
    def setUp(self):
        ...
        # Создаём урок
        self.lesson = Lesson.objects.create(title='Тестовый урок', description='Описание урока', video_url='https://www.youtube.com/watch?v=dQw4w9WgXcQ', owner=self.user, course=self.course)
